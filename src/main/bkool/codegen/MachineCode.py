...
class IllegalOperandException(BaseException):
...
class JasminCode(MachineCode):
    ...
    def emitGOTO(self, label: str) -> str:
        # true_label: _Int->?str
    ...
    def emitINVOKESPECIAL(
        ...
        # Edit
        raise IllegalOperandException("INVOKESPECIAL args None")
    ...
    def emitSTATICFIELD(self, lexeme: str, typ: str, isFinal: bool) -> str:
        ...
        # isFinal: Boolean
        if isFinal:
            return ".field s final " + lexeme + " " + typ + JasminCode.END
        else:
            return ".field s " + lexeme + " " + typ + JasminCode.END
